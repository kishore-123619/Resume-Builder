      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {allResumes.length === 0 ? (
          <div className="rounded-xl border border-dashed border-slate-300 bg-white p-12 text-center text-slate-500">
            <p className="text-lg font-semibold mb-3">No resumes yet</p>
            <p className="max-w-md mx-auto text-sm mb-6">
              Create a new resume or upload an existing PDF to start building
              your profile.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <button
                onClick={() => setShowUploadResume(true)}
                className="px-6 py-2 rounded-full bg-slate-100 text-slate-700 hover:bg-slate-200 transition"
              >
                Upload PDF
              </button>
            </div>
